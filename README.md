...
React bindings for [voxelkloud](../../README.md).
...
<PointCloudViewer
  ...
  lod={{ targetScreenError: 1.0, pointBudget: 3_000_000 }}
...
[@voxelkloud/view](../view/README.md), which knows nothing about React — this
